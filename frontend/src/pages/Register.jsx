    ...
    <div className="relative flex min-h-[80vh] items-center justify-center bg-hero-pattern py-16">
      ...
      <div className="card-lux w-full max-w-md space-y-8 p-10 text-center">
        ...
        <div className="space-y-2">
          <h1 className="font-playfair text-3xl text-gray-900">Join Aurora</h1>
          <p className="text-sm text-gray-500">Create your account to access live luxury gem auctions.</p>
        </div>
        ...
        <p className="text-sm text-gray-500">
          Already have an account? <button className="font-medium text-emerald-700" onClick={() => navigate("/login")}>Sign in</button>
        </p>
      </div>
    </div>
  );
